    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="active">
                    <a href="{{route('blog')}}" class="iq-waves-effect"><i class="ri-briefcase-4-fill"></i><span>Blog Dashboard</span></a>
                </li>
{{--                <li>--}}
{{--                    <a href="dashboard-1.html" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>Hospital Dashboard 1 </span></a>--}}
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="dashboard-2.html" class="iq-waves-effect"><i class="ri-hospital-fill"></i><span>Hospital Dashboard 2</span></a>--}}
{{--                </li>--}}
{{--                <li>--}}
...
{{--// Thêm dữ liệu--}}
{{--                <li>--}}
{{--                    <a href="#doctor-info" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-user-3-fill"></i><span>Users</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>--}}
{{--                    <ul id="doctor-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">--}}
{{--                        <li><a href="{{route('admin.user.index')}}"><i class="ri-profile-fill"></i>Danh sách User</a></li>--}}
{{--                        <li><a href="{{route('admin.user.add')}}"><i class="ri-file-edit-fill"></i> Thêm mới User</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="#doctor-info" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-device-fill"></i><span>Category</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>--}}
{{--                    <ul id="doctor-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">--}}
{{--                        <li><a href="{{route('admin.category.index')}}"><i class="ri-profile-fill"></i>Danh sách danh mục</a></li>--}}
{{--                        <li><a href="{{route('admin.category.add')}}"><i class="ri-file-edit-fill"></i> Thêm mới danh mục</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="#doctor-info" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-table-fill"></i><span>Menu</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>--}}
{{--                    <ul id="doctor-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">--}}
{{--                        <li><a href="{{route('admin.menu.index')}}"><i class="ri-profile-fill"></i>Danh sách sản phẩm</a></li>--}}
{{--                        <li><a href="{{route('admin.menu.add')}}"><i class="ri-file-edit-fill"></i> Thêm mới sản phẩm</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="#doctor-info" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-file-word-fill"></i><span>Reviews</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>--}}
{{--                    <ul id="doctor-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">--}}
{{--                        <li><a href="{{route('admin.review.index')}}"><i class="ri-profile-fill"></i>Danh sách đánh giá</a></li>--}}
{{--                        <li><a href="{{route('admin.review.add')}}"><i class="ri-file-edit-fill"></i> Thêm mới đánh giá</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="#doctor-info" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-message-fill"></i><span>Comments</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>--}}
{{--                    <ul id="doctor-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">--}}
{{--                        <li><a href="{{route('admin.comment.index')}}"><i class="ri-profile-fill"></i>Danh sách bình luận</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="#doctor-info" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-server-fill"></i><span>Configs</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>--}}
{{--                    <ul id="doctor-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">--}}
{{--                        <li><a href="{{route('admin.config.index')}}"><i class="ri-profile-fill"></i>Danh sách config</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="#doctor-info" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-bar-chart-2-fill"></i><span>Seos</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>--}}
{{--                    <ul id="doctor-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">--}}
